	...
	public DeleteCustomer() throws SQLException {
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
                                ResultSet rs = c.s.executeQuery("select * from customer where username = '"+c1.getSelectedItem()+"'"); // we need to add the selected value  variable here.
                                if(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "delete from customer where username = '"+s1+"'"; //"update from customer where username = '"+s1+"'";
