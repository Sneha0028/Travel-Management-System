...
public class Destination extends JFrame implements Runnable {
    ...
    public Destination() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/maldives2.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/m2.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/m5.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/m4.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/l1.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/l2.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/l3.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/k4.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/k2.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/k3.jpg"));
