...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		t1.setColumns(10);
                 ...
                 JLabel la7 = new JLabel("Booking Date");
		la7.setBounds(35, 190, 200, 14);
		contentPane.add(la7);
                
                t7= new JTextField();
                t7.setText("0");
		t7.setBounds(271, 190, 150, 20);
		contentPane.add(t7);
		t7.setColumns(10);
		...
		la6.setBounds(35, 310, 200, 14);
		contentPane.add(la6);
                
                c3 = new Choice();
                c3.add("Yes");
                c3.add("No");
                c3.setBounds(271, 310, 150, 30);
                add(c3);
                
		JLabel lbl1 = new JLabel("ID :");
		lbl1.setBounds(35, 350, 200, 14);
		contentPane.add(lbl1);
                
                JLabel l2 = new JLabel();
		l2.setBounds(271, 350, 200, 14);
		contentPane.add(l2);
		
		JLabel lbl2 = new JLabel("Number :");
		lbl2.setBounds(35, 390, 200, 14);
		contentPane.add(lbl2);
                
                JLabel l3 = new JLabel();
		l3.setBounds(271, 390, 200, 14);
		contentPane.add(l3);
           	
		JLabel lbl3 = new JLabel("Phone :");
		lbl3.setBounds(35, 430, 200, 14);
		contentPane.add(lbl3);
                
                JLabel l4 = new JLabel();
		l4.setBounds(271, 430, 200, 14);
		contentPane.add(l4);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookHotel values('"+l1.getText()+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"','"+la7.getText()+"', '"+t2.getText()+"', '"+c2.getSelectedItem()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
