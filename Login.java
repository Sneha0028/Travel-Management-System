...
public class Login extends JFrame implements ActionListener{
	...
	panel.add(l3);
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("icons/Login1.jpg"));
        Image i1 = c1.getImage().getScaledInstance(175, 160,Image.SCALE_DEFAULT);
	...
	panel.add(l5);
        ...
        panel2.setBackground(new Color(131, 193, 204));
